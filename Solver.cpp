	...
	:H_S(1.0), DT_S(1.0)
{
	...
	mField = new Field(2500, 2500,10, 100);
	//LambdaRange    = Range<double>(Nano_S(400), Nano_S(700), Nano_S(10));
	//WaveAngleRange = Range<int>   (-90, 0, 5);
	LambdaRange = Range<double>(Nano_S(400), Nano_S(700), Nano_S(10));
	WaveAngleRange = Range<int>(-90, -90,10);
	...
	//mModel = new FazzyHair_cuti_only(mField);
	//mModel = new Fazzy_hairslab(mField);
	//mModel = new Fazzy_amber(mField);
	mModel = new Fazzy_amber_noise(mField);
	//mModel = new FazzyMorphoModel(mField, 150, 155, shelf);
	//mModel	= new FazzyMieModel(mField);
	//mModel = new FazzyHair_CrossSection(mField);
	//mModel = new SapphirinidModelSmooth(mField, Inv_Nano_S(lambda_s));
	...
	//mModel = new FazzyHair_simple_cuti_Model(mField);
	//mModel = new FazzyHair_cuti_only(mField);
	//mModel = new FazzyHair_cuti_edage(mField);
...
//mModel    = new FazzySlabModel(mField);
	...
	DataDir		=  "D:\\FDTD_data\\Fazzy_amber_meso\\nsfdtd\\";
	//DataDir = "..\\Data\\Set\\";
	WorkingDir  =  "";
