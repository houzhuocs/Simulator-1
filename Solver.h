...
protected:
	...
	virtual void Initialize(){
		...
		//DataDir		=  "../DataSet/";
		//DataDir = "..\\Data\\Set\\";
		//DataDir = "C:\\Users\\zh\\Desktop\\����\\code from kandasan\\�V�����t�H���_�[\\FDTD-Cpp-master\\";
	...
	double NsCoef(){
		...
		//return (1+((cos(kx_s)*cos(ky_s)-cos(k_s))/(1+ cos(kx_s)*cos(ky_s)- cos(kx_s)-cos(ky_s))))/2;
	}
